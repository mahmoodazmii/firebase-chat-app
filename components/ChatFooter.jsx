...
const ChatFooter = () => {
    ...
    const {isTyping, editMsg, setEditMsg, inputText, 
        setInputText, setAttachment, setAttachmentPreview, attachmentPreview, data} = useChatContext();
  ...
  return (
    <div className="flex items-center bg-c1/[0.5] p-2 rounded-xl relative">
     ...
     >    
        ...
        {editMsg && (
            <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-c4 flex 
            items-center gap-2 py-2 px-4 pr-2 rounded-full text-sm 
